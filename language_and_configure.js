...
global.messAr = {
    success: '* تتم المعالجة !! * ✅️',
    admin: "عزيزي المستخدم ، لا يمكنني متابعة هذا الأمر نيابة عنك. لأنك لست مشرفًا. ",
    botAdmin: "لا يمكنني متابعة هذا الأمر دون أن أكون مشرفاً",
    owner: "لا يمكنك استعمال هذا الامر، هذا مخصص فقط للمالك.",
    group: "لا يمكنك استخدام هذا الأمر لانه متاح فقط في مجموعة",
    private: 'هذا الامر مخصص فقط للشات الخاص😐',
    bot: "هذه الخاصية يمكن استعمالها من طرف البوت فقط.",
